...
body{font-family: 'Open Sans', sans-serif; color:black; font-size:14px; background-image:url(background7.jpg); 
background-size:100% 150%;
padding:100px;}
.form_box{width:400px; padding:10px; background-color:white;}
input{padding:5px;  margin-bottom:5px;}
input[type="submit"]{border:none; outlin:none; background-color:maroon; color:white;}
.heading{background-color:maroon; color:white; height:40px; width:100%; line-height:40px; text-align:center;}
.shadow{
